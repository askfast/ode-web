...
!function ($) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<div class="from_time">from time</div>' +
                    '<div style="">' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
                      //'<input class="input-mini" type="text" name="daterangepicker_end" value="" />' +
                    '</div>' +
                    '<div class="till_time">till time</div><br />' +
                    '<button class="btn btn-small btn-success" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function () {
            ...
            /*
            this.container.find('.from_time').html(this.buildTime());
            this.container.find('.till_time').html(this.buildTime());
            */
        },
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    // for making the days selctable after today
        ...
        buildTime: function() {
            //var html = '<select style="width:120px;" class="chzn-select" tabindex="-1" >';
            var html = '<select style="width:120px;">';
